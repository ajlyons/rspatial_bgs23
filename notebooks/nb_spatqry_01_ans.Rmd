...
circles_sf %>% mutate(col = c("red", "blue", "green"))
...
circles_sf2 <- circles_sf %>% mutate(circle_color = c("red", "blue", "green"))
circles_sf2

tm_shape(circles_sf2) +
  tm_polygons(border.col = "circle_color")

  #tm_borders(col = ~circle_id)
